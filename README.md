...
- [x] [iOS](archived examples.objc)
- [x] [Android](archived examples.android)
- [x] [Java](archived bindingsjava/README.md)
- [x] Linux / [FreeBSD](https://github.com/ggml-org/whisper.cpp/issues/56#issuecomment-1350920264)
- [x] [WebAssembly](archived examples.wasm)
...
As an example, here is a video of running the model on an iPhone 13 device - fully offline, on-device: [whisper.objc](archived examples.objc)
...
- [x] JavaScript: [archived bindingsjavascript](archived bindingsjavascript) | [#309](https://github.com/ggml-org/whisper.cpp/discussions/309)
  - desktop (iOS / Android): [whisper.rn](https://github.com/mybigday/whisper.rn)
- [x] Go: [archived bindingsgo](archived bindingsgo) | [#312](https://github.com/ggml-org/whisper.cpp/discussions/312)
- [x] Java:
  - [GiviMAD/whisper-jni](https://github.com/GiviMAD/whisper-jni)
- [x] Ruby: [archived bindingsruby](archived bindingsruby) | [#507](https://github.com/ggml-org/whisper.cpp/discussions/507)
...
| --------------------------------------------------- | ------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- |
| [whisper-cli](examples/cli)                         | [whisper.wasm](archived examples.wasm) | Tool for translating and transcribing audio using Whisper                                                                       |
...
| [whisper.objc](archived examples.objc)               |                                       | iOS mobile application using whisper.cpp                                                                                        |
| [whisper.swiftui](archived examples.swiftui)         |                                       | SwiftUI iOS / macOS application using whisper.cpp                                                                               |
| [whisper.android](archived examples.android)         |                                       | Android mobile application using whisper.cpp                                                                                    |
| [whisper.nvim](archived examples.nvim)               |                                       | Speech-to-text plugin for Neovim                                                                                                |
