...
export const MARKDOWN_CODE_EDITOR_LINE_NUMBER_OVERLAY_WIDTH = '3.2em';
export const MARKDOWN_CODE_EDITOR_LINE_NUMBER_OVERLAY_GAP = '0.65em';
export const MARKDOWN_CODE_EDITOR_LINE_NUMBER_OVERLAY_RIGHT = '0.65em';
