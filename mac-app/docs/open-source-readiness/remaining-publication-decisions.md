...
Run a dedicated history-aware scanner from the release candidate and rotate anything real that appears in history.

**Brand and icon provenance**

The remaining app icons and logo PNGs need project ownership confirmation, replacement, or removal. This is a source/provenance decision, not a code refactor.
...
Decide whether contributors should use:
...
Issues can be opened for normal bugs, docs, setup problems, and contribution discussions.
